...
Я уже делал подобное на API open.ai, но заставить подобное приложение у себя на компьютере еще не пробовал. 
...
Инициировал проект с помощью uv. Установил Python-библиотеку для работы с Ollama:

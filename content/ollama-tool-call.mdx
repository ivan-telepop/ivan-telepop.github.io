...
ИИ ассистент-продажник анализирует текст, отвечает на вопросы, а в случае необходимости сам вызывает нужную функцию, создает заказ, считает суммы, "выкатывает" счет — всё без участия человека! 
...
В любом бизнесе много таких действий (функций), как правило почти все они могут быть реализованы программно кодом. 

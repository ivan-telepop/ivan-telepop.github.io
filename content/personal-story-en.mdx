...
My name is Ivan, I'm 46 years old. I'm divorced and have two daughters — 14 and 11 years old.  
Most of my professional life has been spent in tech-related fields:  
I’ve worked with video surveillance systems, security systems, computer networks,  
and also as a service engineer for industrial and agricultural equipment.

But what has always attracted me the most is the idea of creating through programming.  
My first experiments were hobbyist projects and prototyping with Arduino.  
There were times when I built websites for small businesses — mostly HTML with some added JavaScript logic.

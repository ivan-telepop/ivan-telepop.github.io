...
Этот сайт написан на React / Next.js</p>
        ...
        {/* <p>
          Скажу откровенно я заебался искать работу последние полтора месяца в свои 46 лет ! 
          Кому то не нравится мой возраст, кому то не нравится как я выгляжу. То еще что то не так...<br/>
          Если нет доверия к человеку, то идите в жопу ! Если есть вера, я готов работать и получать удовольствие от колектива и от работы, 
        ...
        <p>
          Меня уже блевать тянет от ХедХантера и ему подобных, и тянет блевать от культуры подбора персонала. И от всех кто изображает из себя венец творения.
          А еще у меня есть желание съебать в тепло куда нибудь в джунгли или на остров, где не надо тратить нервы на больных уродов которые из-за своих психических проблем начинают друг друга газлайтить, 
          где не надо тратить деньги на дешевый понт. Просто жить! Делать то что тебе нравится и быть собой. 
        </p>

...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  <iframe height={180} width={320} src="/photos/IMG_666.mp4" title="Ivan Goncharov - Job Seeker Video Preview" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
<cite>
  ...
  Так или иначе мне это все близко по духу, и очень нравится работать с данными и кодом ! Думая о перспективах, конечно мне хочется работать и развиваться. <br/>
  Думаю в этом смысле важно найти "своих". Я имею в виду найти тот коллектив, тех кто близок по духу. Говорить на "одном языке", эффективно решать задачи !<br/>
  Возможно вы сейчас в поиске таких людей, хотите создать хороший коллектив!<br/>
  Буду очень рад получить от вас оффер! Для меня это будет хорошая новость ! <br/>
  Желаю хорошего дня ! 

...
<p>
Вы находитесь на моей странице, в моем личном блоге. Я программист самоучка, с опытом работы в разных технологичных сферах, и у меня есть хобби я пишу музыку. 
</p>
<p>Я продолжаю жить и работать, учится, а эта страница в какой то мере отражает мою персональную динамику.</p>
<p>
В течении жизни занимался разным, но в целом все про технологии, Computer Science, и разную электронику. Работал в проектах, решая задачи по построению и оптимизации backend-систем для бизнеса и инфраструктуры, настраивал и поддерживал сети в нескольких компаниях.
</p>
...
<p>- «Компьютерные сети» (Computer Networks). Эндрю Таненбаум</p>

<p>- Essential SQLAlchemy (O'Relly)</p>

<p>- «Грокаем алгоритмы» (структуры данных и алгоритмы)</p>

<p>- «Совершенный код» (о культуре разработки)</p>

<p>- «Использование Docker» (O'Reilly)</p>

<p>- «Kafka. Потоковая обработка данных» (O'Reilly)</p>

<p>- «Python. К вершинам мастерства» (O'Reilly)</p>

<p>- "Паттерны проектирования" (O'Relly)</p>

<p>И другие интересные книги и документация...</p>

...
Строительная компания в которой я работал до сих пор не выплатила мне три месячных оклада, по всей <br/>
видимости не собирается.
Как коллега или работник я исполнителен, 
неплохо разбираюсь в своей профессии, мне нравится она,и я очень много делаю для того чтобы быть профессионалом  
хотя никогда не имел профильного образования. Я самоучка которому нравится работать в сфере  IT. 
Как я говорил выше, с апреля месяца я совершил более 1000 откликов а после увольнения с последнего места работы, 
желая немного сэкономить на жилье я уехал в Грузию в Тбилиси, в город в котором вырос и люблю как город детства. 
В Тбилиси жилье дешевле чем в Москве, не имея дохода на период поиска работы для меня это отличная экономия и подспорье.
Возможно я чрезмерно мнительный но я не мог не заметить очень сильный контраст в активности откликов на мои 
...
всегда был живым, с общением, с интересными интервью, тестовыми заданиями, что очень сильно контрастировало и 
настораживало. <br/>

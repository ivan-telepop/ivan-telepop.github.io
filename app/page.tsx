...
Работал в проектах, решая задачи по построению и оптимизации backend-систем для бизнеса и инфраструктуры.
 ...
 <p>Мой общий трудовой стаж порядка 25 лет. </p>
<p>В 2000-х начинал как самозанятый специалист и занимался монтажом силовой электрики, слаботочных и охранных систем, видеонаблюдение, СКУД, автоматика. </p>
<p>
Считаю это неплохой бекграунд для любого "технаря" !
</p>
Упорство и желание развиваться мне помогли изучать английский язык, а английский язык в свою очередь, 
дал мне доступ к большому количеству открытых курсов, материалов для развития. Khan Akademy, IBM, GeeksForGeeks, книги и другие материалы в открытом доступе 
помогли мне получить знания из открытых источников.
...
<p>
Хочу особенно выделить серию книг O'Rally и материал от Дейва Бизли, он отлично преподает!
Если выпадает случай я обязательно покупаю бумажные книги. 
Но к сожалению из за большого количества переездов, мне не удается собрать большую библиотеку книг в переплете. Спасает SSD диск! 
...
<p>Работая инженером в компаниях мне это дало много ! В целом технический склад ума помогает разбираться в любой архитектуре, инфраструктуре и оптимизации систем.</p>
...
<hr/>
<cite>
  <p className="mb-8 text-xl font-medium tracking-tight">"Пару слов для HR и будущим коллегам: "</p> <br/>
  События последних нескольких лет заставили пересмотреть мои взгляды на жизнь, и в целом изменили мои планы. <br/>
  Профессию разработчика я начал осваивать будучи взрослым, до этого просто эксперементировал с кодом и программированием, в основном как музыкант, делая что то себе или  когда требовалось на работе.<br/>
  Так или иначе мне это все близко по духу, и очень нравится работать с данными и кодом ! А думая о своих перспективах в этом направлении, конечно мне хочется работать и расти. <br/>
  Думаю в этом смысле важна солидарность, быть среди своих. Я имею в виду найти тот коллектив, тех людей в котором будет обоюдно комфортно. Говорить на одном языке, решать совместно задачи !<br/>
  А еще я уверен что работу, нужно выбирать по душе. Когда занятие в радость, и позитивные люди вокруг, то вообще все прекрасно складывается у всех !
  Возможно вы тоже в поиске такого отношения к работе. Было бы здорово найти свой коллектив!<br/>
  Буду очень рад получить, оффер или просто хорошую новость ! <br/>
  Желаю хорошего дня ! 

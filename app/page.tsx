  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
          Прежде всего считаю себя большим эентузиастом, любителем программировать и познавать мир, в особенности достижения людей в области технологий.
          Скорее всего если вы смотрите эту страницу значит вы рассматриваете меня в качестве кандидата на вакансию "бекенд разработчик". Надеюсь вам понравится!
        </p>
        <p>
        ...
        и финансовых сфер. Имею способность мыслить алгоритмически и качественно подходить к поставленным
         ...
         Разрабатывал приложение для предприятий работающих в ресторанном бизнесе, приложение взаимодействует
          ...
          .
          В чуть меньшей степени я занимаюсь фронтенд разработкой, однако то что вы сейчас видите это дело моих рук.

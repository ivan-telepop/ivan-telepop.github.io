...
Если я не получаю зарплату, моя жизнь становится весьма сложной. Я не могу оплачивать жилье, <br/>
не имею возможности оплачивать счета и потребности детей, и в целом жить без дохода в моем положении невозможно.<br/>
В апреле прошлого года мне пришлось уволится с работы из-за давления в коллективе, <br/>
а в компании перед последним местом работы, мне просто перестали платить зарплату объясняя задержку судебными 
тяжбами в фирме и разной чепухой. <br/>
<p>Строительная компания в которой я работал до сих пор не выплатила мне три месячных оклада, по всей <br/>
видимости не собирается.</p>
<p>Как коллега или работник я исполнителен, неплохо разбираюсь в своей профессии, мне нравится она,</p>
<p>и я очень много делаю для того чтобы быть профессионалом  хотя никогда не имел профильного образования. </p>
<p>Я самоучка которому нравится работать в сфере  IT. </p>
<p>Как я говорил выше, с апреля месяца я совершил более 1000 откликов а после увольнения с последнего места работы, </p>
<p>желая немного сэкономить на жилье я уехал в Грузию в Тбилиси, в город в котором вырос и люблю как город детства. </p>
<p>В Тбилиси жилье дешевле чем в Москве, не имея дохода на период поиска работы для меня это отличная экономия и подспорье. </p>
<p>Возможно я чрезмерно мнительный но я не мог не заметить очень сильный контраст в активности откликов на мои </p>
резюме и запросы вакансий. <br/>
Почти сразу как я выехал из России все мои отклики получали только отказ. Хотя в обычной ситуации мой поиск <br/>
всегда был живым, с общением, с интересными интервью, тестовыми заданиями, что очень сильно контрастировало и настораживало. <br/>
Я не хочу погружаться свою ситуацию в конспирологию но по всему было заметно что мои аккаунты имеют явное <br/>
ограничение. <br/>
...
По поведению нанимающих, резкая смена их намерений, отказ брать трубку, порой издевательское отношение <br/>
наводит меня на мысли что словно я в “разработке”, а на меня таким способом оказывают давление или просто издеваются. <br/>
Возможно это связано с моим отношением к событиям в мире, с моими взглядом на гуманизм, открытость образования, <br/>

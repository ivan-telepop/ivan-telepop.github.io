...
<hr/>
<cite>
  <p className="mb-8 text-xl font-medium tracking-tight">"Рекрутерам продактам и эйчарам..."</p> <br/>
  События последних нескольких лет заставили пересмотреть взгляды на жизнь, и в целом сильно изменили мои планы. <br/>
  Профессию бекенд разработчика начал осваивать в 40 лет, до этого эксперементировал с кодом и программированием в основном как музыкант.<br/>
  В то же время, я не могу сказать что я начал изучать backend вынужденно, или именно по финансовым соображениям. Нет ! <br/>
  Так или иначе мне это все близко по духу, и очень нравится ! А проекцируя свои перспективы, получается неплохая картина. <br/>
  Понятное дело ! Как и вам, мне необходимо успешно работать, расти в профессии, развиваться, и конечно я много для этого готов сделать. <br/>
  Как уже писал тут, в моем возрасте начинать что то новое, менять себя, стиль жизни, модель мышления, иногда даже модель поведения. Очень нелегкая задача, особенно когда тебе за 40! <br/>

  И в этом смысле важнее всего, как мне кажется - найти своих. Я имею в виду найти тот коллектив, тех людей в котором будет комфортно и продуктивно работать. Быть "собой", если хотите, и вообще говорить на одном языке !<br/>
  Пока у меня не самый большой опыт работы, но опыт все же есть. Я умею трудится, как мне кажется, неплохо разобрался с предметом, и я конечно понимаю, есть куда расти, чему учиться ! <br/>
  - Если вы видите этот текст, скорее всего я все еще в поиске вакансии. <br/>
  Буду очень рад получить от вас, хорошую новость !<br/>
  Хорошего дня ! 

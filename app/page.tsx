...
- «Компьютерные сети» (Computer Networks). Эндрю Таненбаум

- Essential SQLAlchemy (O'Relly)
...
- "Паттерны проектирования" (O'Relly)

И другие интересные книги и документация...

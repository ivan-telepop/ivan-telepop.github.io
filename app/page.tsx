...
Если я не получаю зарплату, моя жизнь становится весьма сложной. Я не могу оплачивать жилье, 
не имею возможности оплачивать счета и потребности детей, и в целом жить без дохода в моем положении невозможно.<br/>
В апреле прошлого года мне пришлось уволится с работы из-за давления в коллективе, 
...
Строительная компания в которой я работал до сих пор не выплатила мне три месячных оклада, по всей 
видимости не собирается.
Как коллега или работник я исполнителен, неплохо разбираюсь в своей профессии, мне нравится она, 
и я очень много делаю для того чтобы быть профессионалом  хотя никогда не имел профильного образования. 
...
Почти сразу как я выехал из России все мои отклики получали только отказ. Хотя в обычной ситуации мой поиск 
...
Я не хочу погружаться свою ситуацию в конспирологию но по всему было заметно что мои аккаунты имеют явное 
ограничение. <br/>
...
По поведению нанимающих, резкая смена их намерений, отказ брать трубку, порой издевательское отношение 

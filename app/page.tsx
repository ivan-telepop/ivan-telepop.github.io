...
Этот сайт написан на React / Next.js</p>
        ...
        <p>
          Скажу откровенно я заипался искать работу в свои 46 лет, ищу уже полтора месяца ! 
          Кому то не нравится мой возраст, кому то не нравится как я выгляжу. То еще что то не так... <br/>
          Если нет доверия к человеку, то идите лесом ! Если есть вера, я готов работать и получать удовольствие от колектива и от работы, 
        ...
        <p>
          Меня уже блевать тянет от ХедХантеров и ему подобных, и тянет блевать от культуры подбора персонала. И от всех кто изображает из себя венец творения.
          А еще у меня есть желание съебать в тепло куда нибудь в джунгли или на остров, где не надо тратить нервы на психически больных которые из-за своих проблем начинают друг друга газлайтить, 
          и хейтить, где дешевый понт дороже любой порядочности. В общем хочется просто жить! Делать то что тебе нравится и быть собой. 
        </p>
        <p> Тут мой сайт, и по этому пишу что думаю... </p>

            <p> Нужны деньги на билет :</p>

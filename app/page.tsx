...
<cite>
  ...
  Профессию разработчика я начал осваивать взрослым, до этого просто эксперементировал с кодом и программированием, в основном как музыкант,делая что то себе или  когда требовалось на работе.<br/>
  ...
  Вероятно у меня не самый большой опыт работы в сфере разработки, но опыт все же есть. Как мне кажется, я неплохо разобрался с темой бекенда. Конечно есть куда расти, и есть чему поучиться у других ! <br/>
...
<p>
Хочу особенно выделить серию книг O'Rally . Мне очень нравится эта серия ! А еще нравится Дейва Бизли, он очень весело подает материал. С юмором легче усваивать прочитанное!

...
<p>
      ...
      <b>Зачем ?</b> */}
    <p>      
    Изучая материал мне важно его запомнить и осознать,
    ...
    В большей степени я пишу это для себя, чтобы быть в теме или закрепить материал.
    Но если все вы будете пользоваться моими заметками и статьями, 
    или вам покажется подача супер комфортной и понятной. 
